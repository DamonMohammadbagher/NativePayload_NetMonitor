...
## some network traffick monitored by this code , i used this code to monitor some network traffic in my c2 server and client to detect bugs & watching details of payload for http or bmp/png files in payload of http ot tcp or dns packets etc (working on icmp,dns,tcp/udp,http and more ...)
